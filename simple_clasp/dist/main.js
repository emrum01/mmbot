...
/* WEBPACK VAR INJECTION */(function(Buffer) {/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "getImage", function() { return getImage; });
...
const getImage = () => {
  ...
  let dataUrl = "";
  axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(apiUrl, {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* WEBPACK VAR INJECTION */(function(global) {/* harmony import */ var _api_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./api.js */ "./src/api.js");
...
function doPost(e) {
  const dataUrl = Object(_api_js__WEBPACK_IMPORTED_MODULE_0__["getImage"])();
  ...
  var url = 'https://api.line.me/v2/bot/message/reply'; //実際にメッセージを送信する関数
